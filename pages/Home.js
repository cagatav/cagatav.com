    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center">
      <main className="flex flex-col justify-center items-center">
        <h1 className="text-4xl md:text-6xl font-bold text-center">
          <span className="block my-5">Hi, I'm <span className="text-[#903b3b]">Çağatay</span></span>
          <span className="block">A Computer Engineer</span>
        </h1>
        ...
        <div className="flex mt-8 space-x-6">
          <a href="https://www.linkedin.com/in/cagatav" className='icons'>
          ...
          <a href="https://github.com/cagatav" className='icons'>
          ...
          <a href="mailto:cgty.szn@gmail.com" className='icons'>
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24"><path d="M12 2.02c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm0 12.55l-5.992-4.57h11.983l-5.991 4.57zm0 1.288l-6-4.629v6.771h12v-6.771l-6 4.629z"/></svg>
          </a>
        </div>
      </main>
    </div>
